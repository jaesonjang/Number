function generateBacktrackingdata(generatedat,rand_layers_ind...
...
%         ind_layer = 5;
        ...
        save([pathtmp '\Dataset\Data\Fig3_generated_data\Data_for_Backtracking_iter_' num2str(iterind)], ...
            'resp_NS_mean_L45', 'net_changed', 'weights_ForEachL5neuron', ...
