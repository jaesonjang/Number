function [correctratiomat, correcttotdist] = getPerformanceforeachcombinationofnumerosities(Ntmp, sampling_numbers, ...
    correctness_inputnumerosity_dat, iter, averageiter, iterforeachN_val, number_sets)


Ntmp = iterforeachN_val*averageiter*length(number_sets);
