function [respmat, labels]= getmatchingtestdata2(net, LOI, NSind, iterforeachN, image_iter, setNo, number_sets)
...
test_images = [];tmp = cat(5, image_sets_standard_tmp, image_sets_control1_tmp, image_sets_control2_tmp);
for ss = 1:length(setNo)
    setind = setNo(ss);
